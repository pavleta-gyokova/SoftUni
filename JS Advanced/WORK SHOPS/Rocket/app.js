...
class SpaceShip extends HTMLElement {
    ...
    renderStyles_generic() {
        ...
        div { display: block;
            ...
            background-image: url('ship-sprite.gif');
        }
        `;
    };
...
function animate(ship, animateStars) {
    if (ship.getAttribute("engine") === "on") {
        ...
        // const collision = detectCollision(_asteroid, {
        //     top: Number(t),
        //     left: Number(l),
        //     width: 210,
        //     height: 210
...
function main() {
    ...
    const stars = [
        [document.getElementsByTagName('*').far, 1],
        [document.getElementsByTagName('*').mid, 4],
        [document.getElementsByTagName('*').near, 8]
    ]
